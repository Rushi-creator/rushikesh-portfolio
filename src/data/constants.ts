...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "Inventure",
    description: [
      "Frontend and backend development tasks using modern web technologies.",
      "Integration of AI-driven features such as basic automation, data analysis, and intelligent suggestions.",
      "Hands-on experience with version control, testing, and deployment processes.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.NODEJS,
