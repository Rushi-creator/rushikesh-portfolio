    ...
    >
      ...
      <div className={cn(styles.bar, "flex items-center justify-between")}>
        ...
        <div className="flex items-center gap-2" style={{ position: 'relative' }}>
          ...
          <Link href="https://mail.google.com/mail/?view=cm&to=rushikeshgawande8080@gmail.com" target="_blank" style={{ position: 'relative', left: 'auto' }}>
            <Button variant={"ghost"} size={"icon"}>
              <SiGmail size={20} />
            </Button>
          </Link>
          <Link href={config.social.github} target="_blank" style={{ position: 'relative', left: 'auto' }}>
            <Button variant={"ghost"} size={"icon"}>
              <SiGithub size={20} />
            </Button>
          </Link>
