...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "rushikeshgawande8080@gmail",
    href: "mailto:rushikeshgawande8080@gmail.com",
    icon: <FaEnvelope height={"50px"} />,
  },
  {
    name: "Phone",
    content: "+91 8080687145",
    href: "tel:+918080687145",
    icon: <FaPhone height={"50px"} />,
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/rushikesh-gawande-104395257",
    content: "/rushikesh-gawande",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/Rushi-creator",
    content: "/Rushi-creator",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Rushikesh Gawande</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Rushikesh, a results-driven Software Engineer with
              practical experience in full-stack development, cloud fundamentals,
              and modern development practices. I demonstrate strong analytical
              skills, adaptability, and the ability to contribute effectively
              within agile teams to build robust and maintainable software solutions.
            </p>
            <p className="mb-10">
              When I&apos;m not coding, you can find me Sketching, Swimming,
              Reading, or Crafting, exploring new technologies, or sipping coffee
